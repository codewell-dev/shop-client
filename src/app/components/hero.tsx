  ...
  return (
    <section className="hero-section">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://thesalonbarbershop.ch/wp-content/uploads/2023/02/Home_banner_orig.jpg)",
      ...
      <div className="hero-content flex flex-col items-center justify-center min-h-screen text-center px-6 pt-32 pb-20">
        ...
        >
          Curated essentials for the modern gentleman. Professional-grade
          products trusted by master barbers worldwide.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-6 py-5 grid grid-cols-3 divide-x divide-white/10">
          ...
          {[
            ...
            >
              ...
              <span className="font-mono text-white/40 text-xs tracking-widest uppercase mt-1">
                {stat.label}
              </span>
            </div>
          ))}
